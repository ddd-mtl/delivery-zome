...
export class SecretProxy extends ZomeProxy {
  static override readonly DEFAULT_ZOME_NAME = "zSecret";
  static override readonly FN_NAMES = secretFunctionNames;
  static override readonly ENTRY_TYPES = Object.values(SecretUnitEnum);
  static override readonly LINK_TYPES = Object.values(SecretLinkType);
