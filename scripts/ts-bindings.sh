...
zits -d "import {EntryDefIndex} from './deps.types';" -i crates/delivery_types -i crates/delivery_integrity -i crates/delivery_coordinator -i crates/delivery_api -o webcomponents/src/bindings/delivery.ts
