...
export class DeliveryProxy extends ZomeProxy {
  static override readonly DEFAULT_ZOME_NAME = "zDelivery";
  static override readonly FN_NAMES = deliveryFunctionNames;
  static override readonly ENTRY_TYPES = Object.values(DeliveryUnitEnum);
  static override readonly LINK_TYPES = Object.values(DeliveryLinkType);
