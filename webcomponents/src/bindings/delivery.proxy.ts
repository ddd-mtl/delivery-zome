...
export class DeliveryProxy extends ZomeProxy {
  ...
  async queryAllNoticeReceived(): Promise<[EntryHash, NoticeAck][]> {
    return this.call('query_all_NoticeReceived', null);
  }

  async queryNoticeReceived(field: NoticeReceivedQueryField): Promise<NoticeAck[]> {
    return this.call('query_NoticeReceived', field);
  }

  async queryAllDeliveryReply(): Promise<[EntryHash, NoticeReply][]> {
    return this.call('query_all_DeliveryReply', null);
  }

  async queryAllReplyReceived(): Promise<[EntryHash, ReplyAck][]> {
    return this.call('query_all_ReplyReceived', null);
  }

  async queryAllParcelReceived(): Promise<[EntryHash, ReceptionProof][]> {
    return this.call('query_all_ParcelReceived', null);
  }

  async queryParcelReceived(field: ParcelReceivedQueryField): Promise<ReceptionProof | null> {
    return this.call('query_ParcelReceived', field);
  }

  async queryAllDeliveryReceipt(): Promise<[EntryHash, ReceptionAck][]> {
  ...
  async commitNoticeReceived(ack: NoticeAck): Promise<ActionHash> {
    return this.call('commit_NoticeReceived', ack);
  }

  async commitParcelReceived(pr: ReceptionProof): Promise<EntryHash> {
